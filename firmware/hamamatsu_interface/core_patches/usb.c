...
FLASHMEM void usb_init(void) {
  ...
  PMU_REG_3P0 = PMU_REG_3P0_OUTPUT_TRG(0x0F) | PMU_REG_3P0_BO_OFFSET(6) | PMU_REG_3P0_ENABLE_LINREG;
...
#if 1
  if ((USBPHY1_PWD & (USBPHY_PWD_RXPWDRX | USBPHY_PWD_RXPWDDIFF | USBPHY_PWD_RXPWD1PT1 | USBPHY_PWD_RXPWDENV | USBPHY_PWD_TXPWDV2I | USBPHY_PWD_TXPWDIBIAS | USBPHY_PWD_TXPWDFS)) || (USB1_USBMODE & USB_USBMODE_CM_MASK)) {
...
#if 1
			// printf("completestatus=%lX mask=%lX\n", completestatus, endpointN_notify_mask);
      if (completestatus) {
        // transmit:
...
#if defined(CUSTOM_INTERFACE)
      usb_custom_configure();
#endif
